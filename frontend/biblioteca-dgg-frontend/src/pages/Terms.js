                    ...
                    <div className="col-12 col-md-10 col-lg-8">
                        <div className="card p-4 shadow-sm bg-white">
                            ...
                            <div className="row d-flex flex-column mt-4">
                                ...
                                <p>Al registrarte, proporcionas información precisa y actualizada. Eres responsable de mantener la confidencialidad de tu cuenta.</p>
                                ...
                                <ul>
                                    <li>Involucrarte en actividades fraudulentas o ilegales.</li>
                                    <li>Subir o distribuir virus, software malicioso o cualquier otro material dañino.</li>
                                    <li>Utilizar el sitio web de manera que interfiera o interrumpa su funcionamiento o el de servidores y redes conectados.</li>
                                    <li>Utilizar el servicio para acosar, difamar o amenazar a otros usuarios.</li>
                                </ul>
